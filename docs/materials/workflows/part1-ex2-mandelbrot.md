...
1.  Generate a PPM image of the Mandelbrot set:
        ...
        :::console
        username@ap40 $ ./goatbrot -i 1000 -o full.ppm -c 0,0 -w 3 -s 1000,1000
    ...
    -   `-o full.ppm` The output file to generate.
...
1.  Convert the image to the JPEG format (using a built-in program called `convert`):
        ...
        :::console
        username@ap40 $ convert full.ppm mandel.jpg
...
1.  Run goatbroat 4 times:
        ...
        :::console
        username@ap40 $ ./goatbrot -i 1000 -o tile_0_0.ppm -c -0.75,0.75 -w 1.5 -s 500,500
        username@ap40 $ ./goatbrot -i 1000 -o tile_0_1.ppm -c 0.75,0.75 -w 1.5 -s 500,500 
        username@ap40 $ ./goatbrot -i 1000 -o tile_1_0.ppm -c -0.75,-0.75 -w 1.5 -s 500,500 
        username@ap40 $ ./goatbrot -i 1000 -o tile_1_1.ppm -c 0.75,-0.75 -w 1.5 -s 500,500

1.  Stitch the small images together into the complete image (in JPEG format):

        :::console
        username@ap40 $ montage tile_0_0.ppm tile_0_1.ppm tile_1_0.ppm tile_1_1.ppm -mode Concatenate -tile 2x2 tiled.jpg
...
Use `scp` or `sftp` to copy the `mandel.jpg` or `tiled.jpg` back to your computer to view it. 

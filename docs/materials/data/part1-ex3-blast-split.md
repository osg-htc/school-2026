...
``` console
user@ap40 $ osdf object get /osg-public/school/2026/mouse_rna.tar.gz ./
```
...
``` console
user@ap40 $ osdf object get /osg-public/school/2026/gt-1.6.5-Linux_x86_64-64bit-complete.tar.gz ./
```

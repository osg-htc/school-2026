...
The School is held at the
[University of Wisconsin&ndash;Madison](https://www.wisc.edu)
in [Morgridge Hall](https://cai.wisc.edu/morgridge-hall/),
located at
[1205 University Avenue, Madison, WI, 53706](https://maps.app.goo.gl/34dNHS9YQHscokMT6).
The main classroom is Room 2532.

Jump to [local transportation](#local-transportation) below for suggestions about getting around Madison.

## Morgridge Hall, Room 2532

Most School sessions are held in **Room 2532**.
Look for maps or OSG School signs on the second floor,
or ask at the Commons desk (just left if you come out the elevators).

### Restrooms

Restrooms are near the elevators;
ask School staff or out at the Commons desk.
...
The best option for travel between the Madison airport (Dane County Regional Airport) and the [School hotel](hotel.md) is
the [hotel shuttle](#hotel-shuttle) service.
Otherwise, you may use a ride-sharing service or taxi.

<span style="color: #FF6600;">We will help organize groups</span>
to take shuttles or rides,
based on arrival and departure times.
Shuttle/ride groups will be formed and emailed shortly before the School itself.
...
*   **Walking.**
    The hotel is 1.3 miles away from the School.
    Weather is generally great during summer months, and the route is pedestrian-friendly.
*   [**Hotel shuttle service**](#hotel-shuttle) may be available,
    especially if organized in advance.
...
*   Explain that you are a guest at the hotel and
    ask if the shuttle is available for the number of people in your group;
...
*   There are several ways to pay.
    On any bus, you can use the Madison Metro app. 
    On regular routes, you can pay with cash.
    On the rapid routes (A, B, F), you usually need to buy a ticket from the ticket machine at the bus station. 
*   To set up the app: 
...
*   Transit
    ...
    [Apple App Store](https://apps.apple.com/us/app/transit-subway-bus-times/id498151501))
    is great app for finding and real-time tracking of buses.
